...
namespace HearthCalendar.Client.Contracts.Ui;
...
public sealed record GetUpcomingEventsQuery(
    DateOnly From,
    DateOnly To,
    string Calendar = "Combined") : IQuery<UpcomingEventsResult>;
...
public sealed record SubmitWebEventIntentCommand(
    ...
    TimeOnly? EndTime = null) : ICommand<SubmitWebEventIntentResult>;

[BluQubeCommand(Path = "commands/review/approve")]
public sealed record ApproveReviewItemCommand(Guid ReviewDecisionId) : ICommand<ApproveReviewItemResult>;

[BluQubeCommand(Path = "commands/review/reject")]
public sealed record RejectReviewItemCommand(Guid ReviewDecisionId) : ICommand<RejectReviewItemResult>;
...
public sealed record EditReviewItemCommand(
    ...
    DateOnly? Date = null,
    TimeOnly? StartTime = null,
    TimeOnly? EndTime = null) : ICommand<EditReviewItemResult>;
...
public sealed record DeleteEventCommand(
    ...
    string SourceMode = "Interactive") : ICommand<DeleteEventResult>;
...
public sealed record RescheduleEventCommand(
    ...
    string SourceMode = "Interactive") : ICommand<RescheduleEventResult>;

public interface IReviewActionResult
{
    Guid ReviewDecisionId { get; }
...
public sealed record SubmitWebEventIntentResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;

public sealed record ApproveReviewItemResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;

public sealed record RejectReviewItemResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;

public sealed record EditReviewItemResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;

public sealed record DeleteEventResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;

public sealed record RescheduleEventResult(
    Guid ReviewDecisionId,
    string Status,
    string Message,
    Guid? CalendarEventId = null) : ICommandResult, IReviewActionResult;
